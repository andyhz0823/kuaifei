...
#
# 例：
#   remote_mirror_release.sh v1.0.4 /www/wwwroot/kuaifei.top/Downloads \
#     https://github.com/o/r/releases/download/v1.0.4 \
#     Tkya-v1.0.4-android-arm64-v8a.apk ... SHA256SUMS.txt
#
...
# 只接受形如 v1.0.4 的标签，避免拼进 URL/路径后出现问题
